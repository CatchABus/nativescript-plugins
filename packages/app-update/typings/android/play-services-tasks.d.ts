			...
			export module gms {
				export module tasks {
					export class DuplicateTaskCompletionException {
						...
						public static of(task: com.google.android.gms.tasks.Task<any>): java.lang.IllegalStateException;
					}
				}
			}
		}
			...
			export module gms {
				export module tasks {
					export class NativeOnCompleteListener extends com.google.android.gms.tasks.OnCompleteListener<any> {
						...
						public constructor(aTaskPointer: number);
						public onComplete(task: com.google.android.gms.tasks.Task<any>): void;
						...
						public static createAndAddCallback(task: com.google.android.gms.tasks.Task<any>, aTaskPointer: number): void;
					}
				}
			}
		}
			...
			export module gms {
				export module tasks {
					export class TaskCompletionSource<TResult> extends java.lang.Object {
						...
						public constructor();
						public constructor(cancellationToken: com.google.android.gms.tasks.CancellationToken);
						public trySetResult(result: TResult): boolean;
						public trySetException(e: java.lang.Exception): boolean;
						public setResult(result: TResult): void;
						public setException(e: java.lang.Exception): void;
					}
				}
			}
		}
			...
			export module gms {
				export module tasks {
					export class Tasks {
						...
						public static whenAllComplete(executor: java.util.concurrent.Executor, tasks: androidNative.Array<com.google.android.gms.tasks.Task<any>>): com.google.android.gms.tasks.Task<java.util.List<com.google.android.gms.tasks.Task<any>>>;
						public static whenAllComplete(tasks: java.util.Collection<any>): com.google.android.gms.tasks.Task<java.util.List<com.google.android.gms.tasks.Task<any>>>;
						/** @deprecated */
						public static call(callable: java.util.concurrent.Callable<any>): com.google.android.gms.tasks.Task<any>;
						public static whenAllSuccess(executor: java.util.concurrent.Executor, tasks: java.util.Collection<any>): com.google.android.gms.tasks.Task<any>;
						public static whenAll(tasks: java.util.Collection<any>): com.google.android.gms.tasks.Task<java.lang.Void>;
						public static whenAllSuccess(tasks: java.util.Collection<any>): com.google.android.gms.tasks.Task<any>;
						public static await(task: com.google.android.gms.tasks.Task<any>): any;
						public static whenAllSuccess(tasks: androidNative.Array<com.google.android.gms.tasks.Task<any>>): com.google.android.gms.tasks.Task<any>;
						public static whenAllComplete(tasks: androidNative.Array<com.google.android.gms.tasks.Task<any>>): com.google.android.gms.tasks.Task<java.util.List<com.google.android.gms.tasks.Task<any>>>;
						public static forCanceled(): com.google.android.gms.tasks.Task<any>;
						/** @deprecated */
						public static call(executor: java.util.concurrent.Executor, callable: java.util.concurrent.Callable<any>): com.google.android.gms.tasks.Task<any>;
						public static whenAllSuccess(executor: java.util.concurrent.Executor, tasks: androidNative.Array<com.google.android.gms.tasks.Task<any>>): com.google.android.gms.tasks.Task<any>;
						public static withTimeout(task: com.google.android.gms.tasks.Task<any>, timeout: number, unit: java.util.concurrent.TimeUnit): com.google.android.gms.tasks.Task<any>;
						public static whenAllComplete(executor: java.util.concurrent.Executor, tasks: java.util.Collection<any>): com.google.android.gms.tasks.Task<java.util.List<com.google.android.gms.tasks.Task<any>>>;
						public static whenAll(tasks: androidNative.Array<com.google.android.gms.tasks.Task<any>>): com.google.android.gms.tasks.Task<java.lang.Void>;
						public static forException(e: java.lang.Exception): com.google.android.gms.tasks.Task<any>;
						public static forResult(result: any): com.google.android.gms.tasks.Task<any>;
						public static await(task: com.google.android.gms.tasks.Task<any>, timeout: number, unit: java.util.concurrent.TimeUnit): any;
					}
				}
			}
		}
...
declare module com {
	export module google {
		export module android {
			export module gms {
				export module tasks {
					export class zzaa<T> extends java.lang.Object /* com.google.android.gms.tasks.zzab<any>*/ {
						public static class: java.lang.Class<com.google.android.gms.tasks.zzaa<any>>;
						public onSuccess(param0: any): void;
						public onFailure(param0: java.lang.Exception): void;
						public onCanceled(): void;
					}
...
declare module com {
	export module google {
		export module android {
			export module gms {
				export module tasks {
					export class zzab<T> extends java.lang.Object {
						public static class: java.lang.Class<com.google.android.gms.tasks.zzab<any>>;
						/**
						 * Constructs a new instance of the com.google.android.gms.tasks.zzab<any> interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
						 */
...
declare module com {
	export module google {
		export module android {
			export module gms {
				export module tasks {
					export class zzac extends com.google.android.gms.tasks.OnCompleteListener<any> {
	...
	export module google {
		export module android {
			export module gms {
				export module tasks {
					export class zzad {
						public static class: java.lang.Class<com.google.android.gms.tasks.zzad>;
					}
				}
			}
		}
...
declare module com {
	export module google {
		export module android {
			export module gms {
				export module tasks {
					export class zzae<T> extends java.lang.Object /* com.google.android.gms.tasks.zzab<any>*/ {
			...
			export module gms {
				export module tasks {
					export class zzq<TResult> extends java.lang.Object {
						 ...
						 */
						public constructor(implementation: { zza(param0: com.google.android.gms.tasks.Task<any>): void; zzb(): void });
						public constructor();
					}
				}
			}
...
declare module com {
	export module google {
		export module android {
			export module gms {
				export module tasks {
					export class zzy extends com.google.android.gms.tasks.Continuation<any, any> {
...
declare module com {
	export module google {
		export module android {
			export module gms {
				export module tasks {
					export class zzz extends com.google.android.gms.tasks.Continuation<any, any> {
...
//com.google.android.gms.tasks.zzaa:1
//com.google.android.gms.tasks.zzab:1
